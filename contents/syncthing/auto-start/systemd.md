...
2. Copy the service file into the [load path of the/etc/systemd/system system instance][3] (See Table 1. in the appendix below). 
    ...
    ***Situational:** Several distros (among which Arch linux) ship the needed service files with the Syncthing package. If your distro provides a systemd service file for Syncthing, you can skip this step!*
